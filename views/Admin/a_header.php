...
<head>
  ...
  <!--Logo Image-->
    <link rel="icon" type="image/x-icon" href="../images/hub.png">
  <!--Bootstrap Link-->  
...
<nav class="navbar navbar-expand-lg ">
  <div class="container-fluid">
    <a class="navbar-brand" style="margin-left: 30px;" href="#"><img src="../images/logo1.png" height="80px" width="140px" alt=""></a>
